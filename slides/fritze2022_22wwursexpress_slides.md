...
- Apply code formatting<!-- .element: class="fragment" data-fragment-index="0" -->
- check for too large files<!-- .element: class="fragment" data-fragment-index="1" -->
- avoid commiting credentials or broken symlinks<!-- .element: class="fragment" data-fragment-index="2" -->
